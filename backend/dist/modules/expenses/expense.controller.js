...
async function listExpensesHandler(req, res) {
    ...
    const expenses = await expenseService.getAllExpenses({ vehicleId, tripId });
    return (0, apiResponse_1.successResponse)(res, expenses);
}
async function createExpenseHandler(req, res) {
    const expense = await expenseService.createExpense(req.body);
    return (0, apiResponse_1.successResponse)(res, expense, 201);
}
